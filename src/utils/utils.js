...
export const aboutUrl = 'https://www.starqueen.top/about';
...
export function showSuccessMessage(e) {
  message.success(e, 1);
}
...
export function setCookie(key, value) {
  ...
  document.cookie = process.env.NODE_ENV === 'production' ? key + "=" + value + "; " + expires + ';path=/;domain=.starqueen.top' : key + "=" + value + "; " + expires;
}
...
export function filterRecType(recType) {
  ...
  switch (recType) {
  case 1:
    contText = `${formatMessage({id: 'trading.bottom.openMore'})}`;
    break;
  case 0:
    contText = `${formatMessage({id: 'trading.bottom.openEmpty'})}`;
    break;
  case 11: 
    contText = `${formatMessage({id: 'trading.bottom.flatMore'})}`;
    break;
  case 10: 
    contText = `${formatMessage({id: 'trading.bottom.flatEmpty'})}`;
    break;
  default:
    break
  }
